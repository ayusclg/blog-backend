...
import { currentUser, newAccessToken, updateAvatar, updatePassword, updateUser, userLogin, userLogout, userRegister } from "../controllers/user.controller.js";
import Joi from "joi";
import fs from 'fs'
...
router.route("/access").post(newAccessToken)
